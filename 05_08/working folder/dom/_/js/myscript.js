(function() {
	...
	function init_enlargeThmbImg(e) {
		if (e.target.tagName === 'IMG') {
			...
			// img --- create img tag and append to the div tag
			...
			var resizeMyOverlayBackground = function() {
				if (myOverlay) {
					myOverlay.style.width = window.innerWidth + 'px';
					myOverlay.style.height = window.innerHeight + 'px';
			...
			window.addEventListener('resize', resizeMyOverlayBackground, false);
		}
	}
