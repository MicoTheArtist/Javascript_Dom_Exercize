(function() {
	// variables
	var myNode = document.querySelector('article#artlist div.pixgrid ul');
	
	// utility
	
	// init
	function init_enlargeImageThmb(e) {
		if (e.target.tagName === 'IMG') {
			
			// div --- create div opacity background
			...
			// img --- create img tag and append to the div background 
	...
	myNode.addEventListener('click', init_enlargeImageThmb, false);
})();